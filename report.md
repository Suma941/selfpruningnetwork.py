...
The chosen λ values produce moderate sparsity without extreme pruning. However, increasing λ further does not significantly increase sparsity in this setup. This indicates the model has reached a stable pruning regime.
...
- Remaining values spread across a higher range → active weights  
...
- Accuracy remains stable (~52%), indicating reasonable performance retention  
- The approach successfully balances model compression and predictive capability  
